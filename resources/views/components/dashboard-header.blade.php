...
">
                                ...
                                <a class="navbar-brand brand-logo-mini font-weight-bold" href="{{ Auth::user()->is_admin ? "/admin" : "/dashboard" }}
">
                                    SIMANTEN
                                </a>
                            </div>
...
">
                            ...
                            <li class="nav-item">
                                <a href="{{ Auth::user()->is_admin ? '/admin/pengabdian' : '/dashboard/pengabdian' }}
" class="nav-link">
